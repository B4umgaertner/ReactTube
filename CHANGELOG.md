...
## [0.3.1](https://github.com/B4umgaertner/ReactTube/compare/v0.3.0...v0.3.1) (2025-07-03)


### 🐛 Bugfixes

* adapt downloader logic to be less battery intense ([#62](https://github.com/B4umgaertner/ReactTube/issues/62)) ([d752846](https://github.com/B4umgaertner/ReactTube/commit/d7528464a7744107a02bb75b98e6f95862dd0126))


### 🔧 Chore

* add native player history support ([#56](https://github.com/B4umgaertner/ReactTube/issues/56)) ([33c8884](https://github.com/B4umgaertner/ReactTube/commit/33c8884689bd4de0a69c13fbfcc9fbf060ab8074))


### 🚀 Continuous Integration

* add missing github permission to build workflow ([6b8c815](https://github.com/B4umgaertner/ReactTube/commit/6b8c8150c1c94557e7e6a48751ff988bbec95ac7))


### 📄 Documentation

* update readmes for npm preference over yarn atm ([63f37d8](https://github.com/B4umgaertner/ReactTube/commit/63f37d8d2570fc1c6b79503d88a2a2d88c7bd6c8))
